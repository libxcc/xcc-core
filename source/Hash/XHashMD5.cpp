...
_XCOREAPI_ void __xcall__ Xanadu::MD5_Init(XCC_CORE_MD5_CONTEXT* _Context) noexcept
{
...
_XCOREAPI_ void __xcall__ Xanadu::MD5_Update(XCC_CORE_MD5_CONTEXT* _Context, const void* _Data, std::uint64_t _Size) noexcept
{
...
_XCOREAPI_ void __xcall__ Xanadu::MD5_Final(unsigned char* _Result, XCC_CORE_MD5_CONTEXT* _Context) noexcept
{
