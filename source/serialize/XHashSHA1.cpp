...
_XCOREAPI_ void __xcall__ xcc::sha1_compile(XCC_CORE_SHA1_CONTEXT _Context[1]) noexcept
{
...
_XCOREAPI_ void __xcall__ xcc::sha1_begin(XCC_CORE_SHA1_CONTEXT ctx[1]) noexcept
{
...
_XCOREAPI_ void __xcall__ xcc::sha1_hash(const unsigned char _Data[], std::uint64_t _Length, XCC_CORE_SHA1_CONTEXT _Context[1]) noexcept
{
...
_XCOREAPI_ void __xcall__ xcc::sha1_end(unsigned char _Hval[], XCC_CORE_SHA1_CONTEXT _Context[1]) noexcept
{
...
_XCOREAPI_ void __xcall__ xcc::sha1(unsigned char _Hval[], const unsigned char _Data[], unsigned long _Length) noexcept
{
	XCC_CORE_SHA1_CONTEXT    _Context[1];
	xcc::sha1_begin(_Context);
	xcc::sha1_hash(_Data, _Length, _Context);
	xcc::sha1_end(_Hval, _Context);
}
